...
extension EventEditorWizardWebExtension on _EventEditorWizardState {
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Padding(
                          ...
                          child: self._buildWebStepContent(),
                        ),
                      ),
                    ),
                  ),
  ...
  Widget _buildWebStepContent() {
    final self = this;
    switch (self._currentStep) {
      case 0:
        return self._buildWebStep1();
      case 1:
        return self._buildWebStep2();
      case 2:
        return self._buildWebStep3();
      case 3:
        return self._buildWebStep4();
      case 4:
        return self._buildWebStep5();
      case 5:
        return self._buildWebStep6();
      case 6:
        return self._buildWebStep7();
      case 7:
        return self._buildWebStep8();
      default:
        return const SizedBox();
    }
  }

  Widget _arrangeWebToggleBtn({
  ...
  Widget _buildWebStep2() {
    final self = this;
    final quickPresets = [
      {'name': 'Sesi 1', 'start': const TimeOfDay(hour: 7, minute: 0), 'end': const TimeOfDay(hour: 9, minute: 0), 'label': '07:00-09:00'},
      {'name': 'Sesi 2', 'start': const TimeOfDay(hour: 10, minute: 0), 'end': const TimeOfDay(hour: 12, minute: 0), 'label': '10:00-12:00'},
      {'name': 'Sesi 3', 'start': const TimeOfDay(hour: 13, minute: 0), 'end': const TimeOfDay(hour: 15, minute: 0), 'label': '13:00-15:00'},
    ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          InkWell(
                            onTap: () => self._showWebMultiSelectClassesBottomSheet(context, classes),
                            borderRadius: BorderRadius.circular(6),
                            child: Container(
                            ...
                            builder: (context) {
                              ...
                              return InkWell(
                                onTap: self._selectedSubjectId == null
                                    ...
                                    : () => self._showWebSelectTeacherModal(context, teachers, selectedSubjectName),
                                borderRadius: BorderRadius.circular(6),
                                child: Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
                                  decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.meeting_room_outlined, size: 16, color: Color(0xFF4F46E5)),
                          SizedBox(width: 6),
                          Text('Ruangan', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF4F46E5))),
                        ],
                      ),
                    ),
                    Expanded(child: self._buildWebStep5Tab1(classes)),
                  ],
                ),
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.grid_on_rounded, size: 16, color: Color(0xFF4F46E5)),
                          SizedBox(width: 6),
                          Text('Denah', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF4F46E5))),
                        ],
                      ),
                    ),
                    Expanded(child: self._buildWebStep5Tab2(classColors)),
                  ],
                ),
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.groups_rounded, size: 16, color: Color(0xFF4F46E5)),
                          SizedBox(width: 6),
                          Text('Kelas', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF4F46E5))),
                        ],
                      ),
                    ),
                    Expanded(child: self._buildWebStep5Tab3(classes)),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildWebStep5Tab1(List<Map<String, dynamic>> classes) {
    final self = this;
  ...
  Widget _buildWebStep5Tab2(List<Color> classColors) {
    final self = this;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 5),
                      const Text('Kosong', style: TextStyle(fontSize: 11, color: Color(0xFF94A3B8), fontWeight: FontWeight.w500)),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildWebStep5Tab3(List<Map<String, dynamic>> classes) {
    final self = this;
  ...
  void _showWebMultiSelectClassesBottomSheet(BuildContext context, List<Map<String, dynamic>> classes) {
    final self = this;
  ...
  void _showWebSelectTeacherModal(BuildContext context, List<Teacher> teachers, String? selectedSubjectName) {
    final self = this;
    String searchQuery = '';
